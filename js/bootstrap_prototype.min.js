...
enter:function(){var a=this;if(!a.options.delay||!a.options.delay.show)return a.show();clearTimeout(this.timeout);a.hoverState="in";this.timeout=setTimeout(function(){"in"==a.hoverState&&a.show()},a.options.delay.show)},leave:function(){var a=this;this.timeout&&clearTimeout(this.timeout);if(!a.options.delay||!a.options.delay.hide)return a.hide();a.hoverState="out";this.timeout=setTimeout(function(){"out"==a.hoverState&&a.hide()},a.options.delay.hide)},show:function(){var a,b,c,d,e;if(this.hasContent()&&
this.enabled){this.$element.fire("bootstrap:show");a=this.tip();this.setContent();this.options.animation&&a.addClassName("fade");d="function"==typeof this.options.placement?this.options.placement.call(this,a[0],this.$element[0]):this.options.placement;a.setStyle({top:0,left:0,display:"block"});this.options.container?this.options.container.insert(a):this.$element.insert({after:a});b=this.getPosition();c=a.offsetWidth;a=a.offsetHeight;switch(d){case "bottom":e={top:b.top+b.height,left:b.left+b.width/
2-c/2};break;case "top":e={top:b.top-a,left:b.left+b.width/2-c/2};break;case "left":e={top:b.top+b.height/2-a/2,left:b.left-c};break;case "right":e={top:b.top+b.height/2-a/2,left:b.left+b.width}}e.top+="px";e.left+="px";this.applyPlacement(e,d);this.$element.fire("bootstrap:shown")}},applyPlacement:function(a,b){var c=this.tip(),d=c.offsetWidth,e=c.offsetHeight,g,f,h;c.setStyle(a).addClassName(b).addClassName("in");a.top=1*a.top.replace("px","");a.left=1*a.left.replace("px","");g=c.offsetWidth;f=
c.offsetHeight;"top"==b&&f!=e&&(a.top=a.top+e-f,h=!0);"bottom"==b||"top"==b?(e=0,0>a.left&&(e=-2*a.left,a.left=0,a.top+="px",a.left+="px",c.setStyle(a),g=c.offsetWidth),this.replaceArrow(e-d+g,g,"left")):this.replaceArrow(f-e,f,"top");"srting"==typeof a.top&&!a.top.match(/px/)&&(a.top+="px",a.left+="px");h&&c.setStyle(a)},replaceArrow:function(a,b){this.arrow().setStyle({position:a?50*(1-a/b)+"%":""})},setContent:function(){var a=this.tip(),b=this.getTitle();this.options.html||(b=b.escapeHTML());
a.select(".tooltip-inner")[0].update(b);a.removeClassName("fade in top bottom left right")},hide:function(){var a=this,b=this.tip();if("css"==BootStrap.handleeffects&&this.$tip.hasClassName("fade")){var c=setTimeout(function(){b.stopObserving(BootStrap.transitionendevent);b?b.remove():""},500);b.observe(BootStrap.transitionendevent,function(){clearTimeout(c);b?b.remove():"";this.stopObserving(BootStrap.transitionendevent);a.$element.fire("bootrap:hidden")});b.removeClassName("in")}else"effect"==BootStrap.handleeffects&&
this.$tip.hasClassName("fade")?new Effect.Fade(b,{duration:0.3,from:1*b.getOpacity(),afterFinish:function(){b.removeClassName("in");b.remove();a.$element.fire("bootrap:hidden")}}):(b.removeClassName("in"),b.remove(),this.$element.fire("bootrap:hidden"));return this},fixTitle:function(){var a=this.$element;if(a.readAttribute("title")||"string"!=typeof a.readAttribute("data-original-title"))a.writeAttribute("data-original-title",a.readAttribute("title")||"").writeAttribute("title",null)},hasContent:function(){return this.getTitle()},
...
this.$arrow||this.tip().select(".tooltip-arrow")[0]},validate:function(){this.$element[0].parentNode||(this.hide(),this.options=this.$element=null)},enable:function(){this.enabled=!0},disable:function(){this.enabled=!1},toggleEnabled:function(){this.enabled=!this.enabled},toggle:function(a){a=a?$(a.currentTarget)[this.type](this._options).data(this.type):this;a.tip().hasClassName("in")?a.hide():a.show()},destroy:function(){this.hide().$element.stopObserving()}});

...
"auto";this.$element.setStyle(d);b.element.hide()}.bind(this),afterFinish:function(a){d()}.bind(this)}):(d(),this.$element[a]("in"))},toggle:function(){this[this.$element.hasClassName("in")?"hide":"show"]()}});var toggle="[data-toggle=dropdown]";
...
this.options.remote)},toggle:function(){return this[this.isShown?"hide":"show"]()},show:function(a){var b=this;this.$element.setStyle({display:"block"});this.isShown||(this.isShown=!0,this.escape(),this.backdrop(function(){var a=("css"==BootStrap.handleeffects||"effect"==BootStrap.handleeffects&&"undefined"!==typeof Effect&&"undefined"!==typeof Effect.Fade)&&b.$element.hasClassName("fade");b.$element.up().length||$$("body")[0].insert(b.$element);b.$element.setStyle({display:"block"});a&&"css"==BootStrap.handleeffects?
(b.$element.observe(BootStrap.transitionendevent,function(){b.$element.fire("bootstrap:shown")}),setTimeout(function(){b.$element.addClassName("in").writeAttribute("aria-hidden",!1)},1)):a&&"effect"==BootStrap.handleeffects?new Effect.Parallel([new Effect.Morph(b.$element,{sync:!0,style:"top:10%"}),new Effect.Opacity(b.$element,{sync:!0,from:0,to:1})],{duration:0.3,afterFinish:function(){b.$element.addClassName("in").writeAttribute("aria-hidden",!1);b.$element.fire("bootstrap:shown")}}):b.$element.addClassName("in").writeAttribute("aria-hidden",
!1).fire("bootstrap:shown");b.enforceFocus()}))},hide:function(a){this.isShown&&(this.isShown=!1,this.escape(),"css"==BootStrap.handleeffects&&this.$element.hasClassName("fade")?this.hideWithTransition():"effect"==BootStrap.handleeffects&&"undefined"!==typeof Effect&&"undefined"!==typeof Effect.Fade&&this.$element.hasClassName("fade")?this.hideWithTransition():(this.hideModal(),this.$element.setStyle({display:""})))},enforceFocus:function(){var a=this;$(document).on("focus",function(b){a.$element[0]===
...
a.$element.fire("bootrap:hidden")});b.removeClassName("in")}else"effect"==BootStrap.handleeffects&&this.$tip.hasClassName("fade")?new Effect.Fade(b,{duration:0.3,from:1*b.getOpacity(),afterFinish:function(){b.removeClassName("in");b.remove();a.$element.fire("bootrap:hidden")}}):(b.removeClassName("in"),b.remove(),this.$element.fire("bootrap:hidden"));return this},fixTitle:function(){var a=this.$element;(a.readAttribute("title")||"string"!=typeof a.readAttribute("data-original-title"))&&a.writeAttribute("data-original-title",

...
a.top=1*a.top.replace("px","");a.left=1*a.left.replace("px","");f=c.offsetWidth;g=c.offsetHeight;"top"==b&&g!=e&&(a.top=a.top+e-g,h=!0);"bottom"==b||"top"==b?(e=0,0>a.left&&(e=-2*a.left,a.left=0,a.top+="px",a.left+="px",c.setStyle(a),f=c.offsetWidth),this.replaceArrow(e-d+f,f,"left")):this.replaceArrow(g-e,g,"top");"srting"!=typeof a.top||a.top.match(/px/)||(a.top+="px",a.left+="px");h&&c.setStyle(a)},replaceArrow:function(a,b,c){this.arrow().length?this.arrow()[0].setStyle({position:a?50*(1-a/b)+
...
function(){clearTimeout(c);b?b.remove():"";this.stopObserving(BootStrap.transitionendevent);a.$element.fire("bootrap:hidden")});b.removeClassName("in")}else"effect"==BootStrap.handleeffects&&this.$tip.hasClassName("fade")?new Effect.Fade(b,{duration:0.3,from:1*b.getOpacity(),afterFinish:function(){b.removeClassName("in");b.remove();a.$element.fire("bootrap:hidden")}}):(b.removeClassName("in"),b.remove(),this.$element.fire("bootrap:hidden"));return this}},fixTitle:function(){var a=this.$element;(a.readAttribute("title")||
"string"!=typeof a.readAttribute("data-original-title"))&&a.writeAttribute("data-original-title",a.readAttribute("title")||"").writeAttribute("title",null)},hasContent:function(){return this.getTitle()},getPosition:function(){var a=this.$element,b={};"function"==typeof a.getBoundingClientRect?Object.extend(b,a.getBoundingClientRect()):Object.extend(b,{width:a.offsetWidth,height:a.offsetHeight});return Object.extend(b,a.cumulativeOffset())},getTitle:function(){var a=this.$element,b=this.options;return a.readAttribute("data-original-title")||
("function"==typeof b.title?b.title.call(a[0]):b.title)},tip:function(){return this.$tip=this.$tip||this.options.template},arrow:function(){return this.$arrow=this.$arrow||this.tip().select(".tooltip-arrow")},validate:function(){this.$element[0].parentNode||(this.hide(),this.options=this.$element=null)},enable:function(){this.enabled=!0},disable:function(){this.enabled=!1},toggleEnabled:function(){this.enabled=!this.enabled},toggle:function(a){this.tip().hasClassName("in")?this.hide():this.show()},
destroy:function(){this.hide().$element.stopObserving()}});

...
function(){b()}),d.removeClassName("in")):"effect"===BootStrap.handleeffects&&d.hasClassName("fade")&&new Effect.Fade(d,{duration:0.3,from:1*d.getOpacity(),afterFinish:function(){d.removeClassName("in");b()}})}});

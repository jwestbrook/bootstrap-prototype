...
"click",function(a){a.preventDefault();(new BootStrap.Tab(this)).show()});$$('[data-provide="typeahead"]').each(function(a){new BootStrap.Typeahead(a)})});